...
<link rel="stylesheet" href="<?php echo $pontos;?>css/config.css" type="text/css">
<script type="text/javascript" src="<?php echo $pontos; ?>js/functions.js"></script>
</head>
<body>
  <table width="740" height="420" border="0" align="center" cellpadding="1" cellspacing="1">
    ...
    <tr>
      ...
      <td width="589"  valign="top"><?php include ("form_movimento.php"); ?></td>
    </tr>
    <tr>
