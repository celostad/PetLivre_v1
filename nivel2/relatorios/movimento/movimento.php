...
// data inicial
$data_inicial = Convert_Data_Port_Ingl($_POST["txt_data_inicial"]);
$data_periodo_inicial = $_POST["txt_data_inicial"];

// data final
$data_final = Convert_Data_Port_Ingl($_POST["txt_data_final"]);
$data_periodo_final = $_POST["txt_data_final"];
}
