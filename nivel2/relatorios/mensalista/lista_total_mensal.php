...
$data_atual = $h['mday']."-".$mes2."-". $h['year'];

//$data_before = SubtrairData($data_atual, 0, 1, 0);
...
$data_inicial = "01-".$mes2."-".$ano;
$data_final = "31-".$mes2."-".$ano;

//echo "<br>data_atual: ".$data_atual;
...
<title>PetLivre - Sistema para Gerenciamento de Petshop (Relatório de mensalistas) </title>
</head>
<?php
...
}// FECHA if ($txt_mensalista <> $mensalista) ...
...
}// FECHA while($linha_mensal2 ...


// COLOCA DIZERES NO RODAPÉ (FUTURAMENTE COLOCAR NA TABELA)
$rodape = '<b>Referência: '.$mes_conv.'/2011</b>';
$rodape .= '<br><b>Obrigado por confiar em nossos serviços.</b>';
$rodape .= '<br><b><font size="5">Obs: Pagamentos  até o 5º (quinto) dia útil do mês.</font></b>';
