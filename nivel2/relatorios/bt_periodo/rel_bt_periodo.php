...
echo "Periodo entre: <font size=2>".$data_periodo_inicial."</font>&nbsp;&nbsp;á&nbsp;&nbsp;<font size=2>".$data_periodo_final."</font><br><br>";
   ...
   echo "<br><font size=2 color=0000FF><b>Total de Banhos: &nbsp;&nbsp;".$qtde_banhos."</b></font>";
   echo "<br>";
      echo "<br><font size=2 color=0000FF><b>Total de Banhos (Mensalista): &nbsp;&nbsp;".$qtde_banhos_mensal."</b></font>";
