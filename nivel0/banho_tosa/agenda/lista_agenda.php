    ...
    <tr>
      <td height="5" colspan="5"><table width="560" border="0" cellpadding="1" cellspacing="1">
        ...
        <table width="657" border="1" align="center" cellpadding="0" cellspacing="0">
          ...
          <?		  
//- <? echo $dia_mes; de <? echo $mes_conv; de <? echo $ano;
...
?>'">
            <td width="28" height="5" class="info"><div align="center">&nbsp;<? echo $nro; ?></div>
            </td>
...
?>
            ...
            <td width="78" class="info"><div align="center"><? echo $txt_qtde; ?></div>
            </td>
            <td width="75" class="info"><div align="center">&nbsp;<? echo $txt_medida; ?></div>
            </td>
            <td width="79" class="info"><? echo $txt_valor; ?>
