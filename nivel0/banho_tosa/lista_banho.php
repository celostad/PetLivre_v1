      ...
      <td height="5" colspan="5"><table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
          <tr bordercolor="#999999" bgcolor="#999999">
            <td height="22" colspan="7" align="center" bgcolor="#660099" class="titulo_tab_branco_medio_bold"><div align="center">
              <p>              Banho e Tosa - <?php echo $dia_mes;?> de <?php echo $mes_conv;?> de <?php echo $ano;?></p>
            </div></td>
          </tr>
...
?>'">
            <td width="25" height="5" class="info"><div align="center">&nbsp;<?php echo $nro; ?></div></td>
...
?></div></td>
            <td width="97" class="info"><div align="center"><?php echo $txt_qtde; ?></div></td>
            <td width="143" class="info"><div align="center">&nbsp;<?php echo $txt_medida; ?></div></td>
            <td width="107" class="info"><?php echo $txt_valor; ?></td>
            <td width="69" class="info"><div align="center">&nbsp;<?php echo $txt_valor; ?></div></td>
            <td width="91" height="5" class="info"><div align="center">&nbsp;<?php echo $txt_valor; ?></div></td>
<?php }
if ($quantreg==""){
