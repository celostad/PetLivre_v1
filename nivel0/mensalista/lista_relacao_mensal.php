...
<?php
 ...
 // Faz o Select pegando o registro inicial at&eacute; a quantidade de registros para p&aacute;gina
    $sql_registros = mysql_query("SELECT * FROM tab_pet WHERE mensalista='Sim' ORDER BY codigo ASC LIMIT $inicio, $total_reg");

// Serve para contar quantos registros voc&ecirc; tem na seua tabela para fazer a pagina&ccedil;&atilde;o
    $sql_conta = mysql_query("SELECT * FROM tab_pet WHERE mensalista='Sim'");
...
?>'">
            <td width="70" height="5" class="info"><div align="center">&nbsp;<? echo $nro; ?></div></td>
            <td width="252" class="info"><div align="center"><? echo $nome_pet; ?></div></td>
            <td width="252" class="info"><div align="center"><? echo $nome_dono; ?></div></td>
