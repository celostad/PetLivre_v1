...
$sql1 = mysql_query("UPDATE `tab_temp_caixa` SET  cod_produto='$txt_cod_prod', produto='$txt_produto', pet='$txt_pet', qtde='$txt_qtde', medida='$sel_medida',
 valor='$txt_valor', especie='$txt_especie', obs='$txt_obs_caixa', data ='$data_atual' WHERE usuario='$usuario'") or die (mysql_error());
...
$sql2 = mysql_query("INSERT INTO `tab_temp_caixa` (`codigo`, `cod_produto`, `produto`, `pet`, `qtde`, `medida`,`valor`, `especie`, `obs`, 
...
echo '<script>window.location = "../entrada_caixa.php";</script>';break;}
