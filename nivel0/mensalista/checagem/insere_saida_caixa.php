...
$sql1 = mysql_query("UPDATE `tab_temp_caixa` SET  cod_material='$txt_cod_material', material='$txt_material', qtde='$txt_qtde', medida='$sel_medida',
...
$sql2 = mysql_query("INSERT INTO `tab_temp_caixa` (`codigo`, `cod_material`, `material`, `qtde`, `medida`,`valor`, `especie`, `obs`, 
