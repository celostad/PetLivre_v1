...
if (!isset($txt_nome_clie)) {$txt_nome_clie = '';}
if (!isset($txt_end_clie)) {$txt_end_clie = '';}
if (!isset($txt_cep_clie)) {$txt_cep_clie = '';}
if (!isset($txt_ddd_tel_clie)) {$txt_ddd_tel_clie = '';}
if (!isset($txt_ddd_cel_clie)) {$txt_ddd_cel_clie = '';}
if (!isset($txt_tel_clie)) {$txt_tel_clie = '';}
if (!isset($txt_cel_clie)) {$txt_cel_clie = '';}
if (!isset($txt_cpf)) {$txt_cpf = '';}
if (!isset($txt_rg_clie)) {$txt_rg_clie = '';}
if (!isset($txt_data_nasc_clie)) {$txt_data_nasc_clie = '';}
if (!isset($txt_obs_clie)) {$txt_obs_clie = '';}
...
<table width="550" border="0" bordercolor="#cccccc" height="244" align="left" cellpadding="0" cellspacing="0">
  <tr>
    <td width="550" height="22" valign="top" bgcolor="#66CC66"><div align="center" class="style3"><strong>
      <?php if (empty($rad_sel_visl)){ echo "Cadastro de Cliente";}else{echo "Cadastro de Cliente (".$rad_sel_visl.")";}?>
    </strong></div></td>
  </tr>
  <tr>
      ...
      <tr>
        <td width="360"><table width="360" border="0" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="278" height="20"><input name="txt_nome_clie"  tabindex="1" type="text" id="txt_nome_clie" value="<?php echo $txt_nome_clie; ?>" size="42" /></td>
            </tr>
        </table></td>
      ...
      <tr>
        <td width="360"><table width="360" border="0" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="278" height="20"><input name="txt_end_clie" tabindex="2" type="text" id="txt_end_clie" value="<?php echo $txt_end_clie; ?>" size="42" /></td>
            </tr>
        </table></td>
      </tr>
      <tr>
...
?>
              ...
              <td width="77"><input name="txt_cep_clie" tabindex="4" type="text" id="cep" onkeyup="formata_cep(this.value); somente_numeros(this);" value="<?php echo $txt_cep_clie; ?>" size="7" maxlength="9" /></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td width="360"><table width="360" border="0" cellspacing="1" cellpadding="1">
            <tr>
              ...
              <td width="211"><font size="2"><b><font face="Times New Roman, Times, serif" size="2">
                <?php
$sql_3 = mysqli_query($connection, "select * from combo_cidade ORDER BY cidade ASC") or print("Erro ao ler a tabela: Cidade ".mysqli_error());
      ...
      <tr>
        <td width="360" height="61"><table width="360" height="59" border="0" cellpadding="1" cellspacing="1">
            <tr>
              ...
              <td width="282" height="55"><textarea name="txt_obs_clie" cols="33" rows="3" id="txt_obs_clie" tabindex="15"><?php echo $txt_obs_clie; ?></textarea>
                  <?php //echo $retorno; ?></td>
            </tr>
        </table></td>
      </tr>
