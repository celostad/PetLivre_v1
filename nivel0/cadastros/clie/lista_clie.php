...
$sql_registros = mysqli_query($connection, "SELECT * FROM tab_clie ORDER by data_cadastro DESC  LIMIT $inicio,$total_reg");
...
if (!empty($txt_ddd_tel_clie)){$txt_ddd_tel=$txt_ddd_tel_clie; $txt_ddd_cel_clie="";}
if (!empty($txt_tel_clie)){$txt_tel=$txt_tel_clie;$txt_cel_clie="";}
if (!empty($txt_ddd_cel_clie)){$txt_ddd_tel=$txt_ddd_cel_clie;}
if (!empty($txt_cel_clie)){$txt_tel=$txt_cel_clie;}
