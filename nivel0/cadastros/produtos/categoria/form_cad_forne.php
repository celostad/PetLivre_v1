        ...
        <td width="360"><table width="360" height="59" border="0" cellpadding="1" cellspacing="1">
          <tr>
            <td width="60" height="55"><div align="right"><strong><font size="2">Obs:</font></strong></div></td>
              <td width="282" height="55"><textarea name="txt_obs_forne" cols="33" rows="4" id="txt_obs_forne" tabindex="14"><?php echo $txt_obs_forne; ?></textarea><?// echo $rad_sel_visl //$link; "<br>"//$retorno; ?></td>
            </tr>
        </table></td>
      </tr>
