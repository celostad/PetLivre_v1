<?php
$sql_ref = mysqli_query($connection, "SELECT * FROM `tab_temp_pet` WHERE user_cadastro='$usuario'") or die("erro ao selecionar sql_ref");
...
if (!isset($txt_data_nasc) || $txt_data_nasc =="0000-00-00") {$txt_data_nasc = '';}
