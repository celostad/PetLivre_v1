    ...
    <td height="20"><table width="555" border="0" align="left" cellpadding="1" cellspacing="1">
      <tr>
        <td width="554" align="center" bgcolor="#0099CC"><div align="left" class="style3">
          <div align="center"><strong><? if (empty($rad_sel_visl)){ echo "Cadastro de Pet";}else{echo "Cadastro de Pet (".$rad_sel_visl.")";}?></strong></div>
        </div></td>
      </tr>
	  <tr>
	  		<td height="5"></td>
      ...
      <tr>
        <td width="360"><table width="360" height="20" border="0" cellpadding="2" cellspacing="1">
          <tr>
            ...
            <td width="114" height="20"><input name="txt_nome_pet" type="text" id="txt_nome_pet" tabindex="1" value="<? echo $txt_nome_pet; ?>" size="19"/></td>
...
<?
$sql_2 = mysql_query("select * from combo_raca ORDER BY raca ASC") or print("Erro ao ler a tabela:
".mysql_error());
        ...
        <td width="360"><table width="360" border="0" cellspacing="1" cellpadding="1">
          <tr>
            ...
            <td width="173" height="20"><font size="2"><b><font face="Times New Roman, Times, serif" size="2">
              <?
$sql_1 = mysql_query("select * from combo_cor ORDER BY cor ASC") or print("Erro ao ler a tabela:
".mysql_error());
echo "<select name='txt_cor' id='txt_cor' tabindex='5' onchange='javascript:cad_cor()'>";
if (!empty($txt_cor)){
echo "<option value='".$txt_cor."'>".$txt_cor."</option>";
echo "<option>"."</option>";
while($pega1 = mysql_fetch_array($sql_1)){
        ...
        <td width="360"><table width="360" border="0" cellspacing="1" cellpadding="1">
          <tr>
            ...
            <td width="110"><font size="2">
              <input name="txt_data_nasc" type="text" id="txt_data_nasc" onchange="validaData(this);" onkeyup="formata(this);" value="<? echo $txt_data_nasc; ?>" size="8" maxlength="10" tabindex="7" />
            </font></td>
        ...
        <td width="360"><table width="360" border="0" cellspacing="1" cellpadding="1">
          <tr>
            ...
            <td width="139"><font size="2" face="Times New Roman, Times, serif"><b>
              <input name="txt_chip" type="text" id="txt_chip" tabindex="9" onkeyup="somente_numeros(this);" value="<? echo $txt_chip; ?>" size="14" maxlength="14" />
              </b></font></td>
            ...
            <td width="122" height="20"><font size="2" face="Times New Roman, Times, serif"><b>
              <input name="txt_rga" type="text" id="txt_rga" tabindex="10" value="<? echo $txt_rga; ?>" size="9" maxlength="11" />
            </b></font></td>
          </tr>
        </table></td>
      </tr>
...
$sql_pet = mysql_query("select codigo, cod_dono from tab_pet WHERE codigo='$txt_cod'") or print("Erro ao ler a tabela: tab_pet".mysql_error());
if ($linha_pet = mysql_fetch_array($sql_pet)){
$codDono_bd = $linha_pet['cod_dono'];
}

if (!empty($codDono_bd)){
$sql_1 = mysql_query("select codigo, nome from tab_clie WHERE codigo='$codDono_bd'") or print("Erro ao ler a tabela: tab_clie".mysql_error());
if ($linha_dono = mysql_fetch_array($sql_1)){
...
$sql_2 = mysql_query("select codigo, nome from tab_clie WHERE codigo='$txt_cod_dono'") or print("Erro ao ler a tabela: tab_clie".mysql_error());
if ($linha_dono2 = mysql_fetch_array($sql_2)){
...
$sql_1 = mysql_query("select codigo, nome from tab_clie ORDER BY nome ASC") or print("Erro ao ler a tabela:
".mysql_error());
        ...
        <td width="360"><table width="360" height="59" border="0" cellpadding="1" cellspacing="1">
          <tr>
            <td width="60" height="55"><div align="right"><strong><font size="2">Obs:</font></strong></div></td>
              <td width="282" height="55"><textarea name="txt_obs_pet" cols="33" rows="4" id="txt_obs_pet" tabindex="12"><? echo $txt_obs_pet; ?></textarea><?php //echo $codDono_bd; ?></td>
            </tr>
        </table></td>
      </tr>
