...
<form method="POST" enctype="multipart/form-data" name="form">
 ...
 // Faz o Select pegando o registro inicial at&eacute; a quantidade de registros para p&aacute;gina
    $sql_registros = mysql_query("SELECT * FROM tab_pet ORDER BY nome ASC LIMIT $inicio, $total_reg");

// Serve para contar quantos registros voc&ecirc; tem na seua tabela para fazer a pagina&ccedil;&atilde;o
    $sql_conta = mysql_query("SELECT * FROM tab_pet");
...
?>'">
              ...
              <td width="179" height="5" class="info"><div align="center">&nbsp;<? echo $txt_nome; ?></div></td>
              <td width="108" height="5" class="info"><div align="center">&nbsp;<? echo $txt_raca; ?></div></td>
              <td width="122" class="info"><div align="center">&nbsp;<? echo $txt_cor; ?></div></td>
              <td width="71" height="5" class="info"><div align="center">&nbsp;<? echo $nome_dono[0]; ?></div></td>
              <td width="60" height="5" colspan="2" class="info">&nbsp;<? 
