...
$sql_ref = mysql_query("SELECT * FROM `tab_temp_agenda_fone` WHERE user_cadastro='$usuario'") or die("erro ao selecionar1");
...
<table width="740" height="420" border="0" align="center" cellpadding="1" cellspacing="1">
  ...
  <tr>
    ...
    <td width="589" valign="top"><div align="center"><? include("lista_clie.php"); ?></div></td>
  </tr>
  <tr>
