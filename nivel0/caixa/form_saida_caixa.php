...
<form name="form" enctype="multipart/form-data" method="POST">
  <table width="400" border="0" bordercolor="#cccccc" height="235" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="547" height="22" valign="top" bgcolor="#CC0000"><div align="center" class="style3"><strong> <?php echo "Saída no caixa  -  ";?> 
          ...
          <td width="547"><table width="400" border="0" cellspacing="1" cellpadding="1">
              <tr>
                ...
                <td width="286" height="20"><div align="left"><font size="2"><b><font face="Times New Roman, Times, serif" size="2">
                    <?
$sql_2 = mysqli_query($connection, "select codigo, material from tab_material ORDER BY material ASC") or print("Erro ao ler a tabela:
        ...
        <tr>
          <td><table width="400" border="0" cellpadding="1" cellspacing="1">
            <tr>
              ...
              <td width="289"><input name="txt_qtde" type="text" id="txt_qtde" tabindex="4" value="<?php echo $txt_qtde; ?>" size="6" maxlength="9"/></td>
            </tr>
          </table></td>
        </tr>
        <tr>
