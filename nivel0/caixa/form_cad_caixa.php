...
-->
  ...
  <table width="385" border="0" bordercolor="#cccccc" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
      ...
      <td width="547" height="22" valign="top" bgcolor="#CC0000"><div align="center" class="style3"><strong> <?php echo "Entrada no caixa  -  ";?> 
...
<input type="hidden" id="dados" name="txt_cod_prod" value="">			  
                ...
                <td width="113" id="esconde2" style="<?=$x;?>" ><div align="left">
                  <input name="txt_pet" type="text" id="txt_pet" value="<?php echo $txt_pet; ?>" size="10" maxlength="20" />
        ...
        <tr>
          <td><table width="410" border="0" cellpadding="1" cellspacing="1">
            <tr>
              ...
              <td width="290"><input name="txt_qtde" type="text" id="txt_qtde" tabindex="2" value="<?php echo $txt_qtde; ?>" size="5" maxlength="6" /></td>
            </tr>
          </table></td>
        </tr>
        <tr>
            ...
            <tr>
              ...
              <td width="290"><font size="2"><b><font face="Times New Roman, Times, serif" size="2"><strong><font size="2">
                <select name="sel_medida" tabindex="3" id="sel_medida" >
                  <option value="<?php echo $sel_medida; ?>"><?php echo $sel_medida; ?></option>
                  <option></option>
          ...
          <td width="424"><table width="410" border="0" cellspacing="1" cellpadding="1">
              <tr>
                ...
                <td width="290" height="20"><div align="left"><font size="2"><b><font face="Times New Roman, Times, serif" size="2"></a></font></b></font><font size="2"><b><font face="Times New Roman, Times, serif" size="2"><strong><font size="2">
                    <?php
$sql_4 = mysqli_query($connection, "select codigo, especie from combo_especie ORDER BY codigo ASC") or print("Erro ao ler a tabela: ".mysqli_error($connection));
        ...
        <tr>
          <td width="424" height="61"><table width="410" height="68" border="0" cellpadding="1" cellspacing="1">
              <tr>
                ...
                <td width="290" height="66"><textarea name="txt_obs_caixa" cols="33" rows="3" id="txt_obs_caixa" tabindex="6"><?php echo $txt_obs_caixa; ?></textarea>
                    <?php //echo $retorno; ?></td>
              </tr>
          </table></td>
        </tr>
