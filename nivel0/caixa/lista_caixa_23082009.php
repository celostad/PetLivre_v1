...
?>
			...
			<?php echo '<a href="javascript:popup_libera_total_caixa()">Total</a>';//echo number_format($total1, 2, ',','.');?></font></div>
            <input type="hidden" name="valor" id="valor" value="<?php echo $total1; ?>">
            </td>
