...
<?php
 ...
 // Faz o Select pegando o registro inicial at&eacute; a quantidade de registros para p&aacute;gina
    $sql_registros = mysql_query("SELECT * FROM tab_caixa WHERE especie=7 and produto <>'' ORDER BY data ASC LIMIT $inicio, $total_reg");

// Serve para contar quantos registros voc&ecirc; tem na seua tabela para fazer a pagina&ccedil;&atilde;o
    $sql_conta = mysql_query("SELECT * FROM tab_caixa WHERE especie=7 and produto <>''  ORDER BY data ASC");
...
?>'">
            <td width="34" height="5" class="info"><div align="center">&nbsp;<? echo $nro; ?></div></td>
            <td width="115" class="info"><div align="center"><? echo $txt_data; ?></div></td>
...
?></div></td>
            ...
            <td width="273" class="info"><div align="center">&nbsp;<? echo $txt_medida; ?></div></td>
            <td width="164" class="info"><div align="center"><? echo number_format($txt_valor, 2, ',','.'); ?></div></td>
