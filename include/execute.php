...
// This code was created by phpMyBackupPro v.2.1 
// http://www.phpMyBackupPro.net
$_POST['db']=array("maypet02", );
$_POST['tables']="on";
$_POST['data']="on";
$_POST['drop']="on";
$_POST['mysql_host']="-1";
$period=(3600*24)*1;
$security_key="e46c0fe4ea914b78d0af9615191fb149";
...
while ($linha1 = mysql_fetch_array($sql_cartao1)){
	...
	$assunto = utf8_decode("Maypet - Crédito em Conta Corrente");
...
while ($linha1 = mysql_fetch_array($sql_cartao1)){
	...
	$assunto = utf8_decode("Maypet - Débito em Conta Corrente");
